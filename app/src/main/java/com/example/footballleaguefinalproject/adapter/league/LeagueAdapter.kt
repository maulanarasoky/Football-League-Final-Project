package com.example.footballleaguefinalproject.adapter.league
...
import com.example.footballleaguefinalproject.activity.league.DetailsLeagueActivity
...
class LeagueAdapter(private val context : Context, private val items : List<League>) : RecyclerView.Adapter<LeagueAdapter.ViewHolder>() {
