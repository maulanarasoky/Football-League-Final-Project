package com.example.footballleaguefinalproject.adapter.match
...
import com.example.footballleaguefinalproject.activity.match.DetailsMatchActivity
...
class MatchAdapter(
    ...
    private val dataTeam: List<Team>
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        for (i in dataTeam.indices){
            if (dataMatch[position].idHomeTeam.equals(dataTeam[i].idTeam)){
            ...
            if(dataMatch[position].idAwayTeam.equals(dataTeam[i].idTeam)){
